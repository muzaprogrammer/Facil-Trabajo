  ...
  <?php foreach($query->result_array() as $row){ ?>
      <tr>
        ...
        <td style="text-align:center">
          <a class="btn btn-info" onclick="editar_publicacion(<?php echo $row['idofertasEmpleo'];?>)"><i class="fa fa-edit"></i></a>

          <a class="btn btn-primary" onclick="eliminar_publicacion('<?php echo $row['idofertasEmpleo'];?>')"><i class="fa fa-trash-o"></i></a>
