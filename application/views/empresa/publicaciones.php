        ...
        <form class="form-horizontal margin-none" id="form-buscar_alumno" method="get" autocomplete="off">
          ...
          <div class="widget widget-inverse">
            ...
            <div class="widget-head">
              <h4 class="heading">Administracion de Publicaciones</h4>
            </div>
            <!-- // Widget heading END -->
            <div class="widget-body">
              <span class="btn btn-success" onclick="registrar();"><i class="fa fa-plus"></i>Agregar Publicaciones</span>
              <br/>
              <hr class="separator" />
